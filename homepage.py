...
st.page_link(
    page="https://www.bilibili.com/video/BV1Mm4y1D7oJ/?spm_id_from=333.337.search-card.all.click&vd_source=2e464198d692ab7e2865fa7d375f6634", 
    label="Embedding Projector Tutorial",
    icon = "🪑"
    )